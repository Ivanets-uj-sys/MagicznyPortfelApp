...
abstract class AbstractBaseFixtures extends Fixture
{
    ...
    /**
     * Get all references by group name and class name.
     *
     * @param string $referenceGroupName Objects reference group name
     * @param string $className          Objects class name
     *
     ...
     */
    protected function getAllReferences(string $referenceGroupName, string $className): array
    {
        $referenceNames = $this->getReferenceNameListByClassName($referenceGroupName, $className);

        return array_map(fn (string $name) => $this->getReference($name, $className), $referenceNames);
    }
